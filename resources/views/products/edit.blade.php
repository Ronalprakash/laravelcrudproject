...
<div class="col-md-8">
  <form action="/products/{{ $hi->id }}/update" enctype="multipart/form-data" method="POST">
      @csrf
      <div class="row mb-3">
          <div class="col-md-12">
              ...
              <input type="text" name="name" id="name" class="form-control
               @if($errors->has('name')) {{ 'is-invalid' }} @endif "
                placeholder="Enter a Product name" value="{{ old('name',$hi->name) }}">
                @if($errors->has('name'))
      ...
      <div class="row mb-3">
          <div class="col-md-6">
              ...
              " placeholder="Enter a M.R.P" value="{{ old('mrp',$hi->mrp) }}">
              @if($errors->has('mrp'))
          ...
          <div class="col-md-6">
                  ...
                  " placeholder="Enter a selling price" value="{{ old('price',$hi->price) }}">
                  @if($errors->has('price'))
  ...
  <div class="row mb-3">
      <div class="col-md-12">
          ...
          " placeholder="Enter a Description" value="{{ old('description',$hi->description) }}"></textarea>
  ...
  <div class="row mb-3">
      ...
      <div class="mb-3">
          <button type="submit" class="btn btn-dark">upsate Product</button>
